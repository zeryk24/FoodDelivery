...
public class GetMealsByTypeQueryTests
{
    private readonly DbContextOptions<ApplicationDbContext> _options;
    
    public GetMealsByTypeQueryTests()
    {
    ...
    [Fact]
    public async void GetMealsByType_ValidString_ValidMeals()
    {
        await using var dbContext = new ApplicationDbContext(_options);

        var query = new GetMealsByTypeQueryObject(dbContext);
    ...
    [Fact]
    public async void GetMealsByType_InvalidString_Empty()
    {
        await using var dbContext = new ApplicationDbContext(_options);

        var query = new GetMealsByTypeQueryObject(dbContext);
        query.UseFilter("whatever");
    ...
    [Fact]
    public async void GetMealsByType_ValidStringFiltered_ValidMealsFiltered()
    {
        await using var dbContext = new ApplicationDbContext(_options);
    ...
    [Fact]
    public async void GetMealsByType_ValidStringPaged_ValidMealsPaged()
    {
        await using var dbContext = new ApplicationDbContext(_options);
    ...
    [Fact]
    public async void GetMealsByType_ValidStringOrdered_ValidMealsOrdered()
    {
        await using var dbContext = new ApplicationDbContext(_options);
